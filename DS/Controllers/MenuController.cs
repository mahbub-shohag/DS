...
namespace DS.Controllers
{
    public class MenuController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            var CAS = GetList("Controller");
            var AS = GetList("Action");
        ...
        public List<ControllerAction> GetList(string Content)
        {
            ...
            {
                List<ControllerAction> AS = new List<ControllerAction>();
                AS = ControllerActions.ToList(); 
                return AS;
            }
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var AS = GetList("Action");
            @ViewBag.Controller = new SelectList(CAS, "Controller", "Controller");
            @ViewBag.Action = new SelectList(AS, "Action", "Action");
            @ViewBag.ParentId = new SelectList(context.menus, "Id", "Caption");
            return View(menu);
        }
